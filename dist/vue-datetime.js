...
function weekdays (weekStart) {
  ...
  var weekDays = ['周一', '周二', '周三', '周四', '周五', '周六', '周日'].map(function (weekday) { return capitalize(weekday); });
...
function months () {
  return ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'].map(function (month) { return capitalize(month); })
}
